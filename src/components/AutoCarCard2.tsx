...
const AutoCarCard2: React.FC<AutoCarCard2Props> = ({
  ...
  return (
    <Card className={`group overflow-hidden bg-gradient-to-br from-gray-900 to-black border-gray-800 hover:shadow-2xl hover:shadow-yellow-500/20 transition-all duration-500 hover:-translate-y-2 hover:border-yellow-500/30 w-[380px] lg:w-[420px] flex-shrink-0 ${className}`}>
